document.addEventListener('DOMContentLoaded', () => {
    ...
    const fetchSales = async () => {
        try {
            ...
            fechaCell.innerHTML = `<span data-order="${sale.fecha}">${formatDate(sale.fecha)}</span>`;
                ...
                totalCell.setAttribute('data-order', sale.total); // valor numérico para orden correcto
